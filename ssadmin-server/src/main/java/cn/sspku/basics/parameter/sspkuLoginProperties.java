package cn.sspku.basics.parameter;
...
@Data
@Configuration
public class sspkuLoginProperties {
    ...
    public static final String HTTP_TOKEN_PRE = "sspku_TOKEN_PRE:";

    public static final String USER_TOKEN_PRE = "sspku_USER_TOKEN:";
}
