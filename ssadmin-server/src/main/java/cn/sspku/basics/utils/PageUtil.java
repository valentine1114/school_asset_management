...
public class PageUtil {
    ...
    public static Pageable initPage(PageVo page){
        ...
        if(!sspkuNullUtils.isNull(sort)) {
            Sort.Direction direction = sspkuNullUtils.isNull(order) ? Sort.Direction.DESC : Sort.Direction.valueOf(order.toUpperCase());
    ...
    public static Page initMpPage(PageVo page){
        ...
        if(!sspkuNullUtils.isNull(sort)) {
            Boolean isAsc = false;
            if(sspkuNullUtils.isNull(order)) {
                isAsc = false;
            } else {
    ...
    public static String camel2Underline(String underlineContent) {
        if (sspkuNullUtils.isNull(underlineContent)) {
            return NULL_STR;
        }
