package cn.sspku.basics.code;

import cn.hutool.core.date.DateUtil;
import cn.sspku.basics.code.bean.Entity;
import cn.sspku.basics.code.bean.Item;
...
public class MyBatisPlusCodeUtils {
    ...
    private static final String entityPackage = "cn.sspku.test.entity";

    @ApiModelProperty(value = "dao对应包")
    private static final String daoPackage = "cn.sspku.test.mapper";

    @ApiModelProperty(value = "service对应包")
    private static final String servicePackage = "cn.sspku.test.service";

    @ApiModelProperty(value = "serviceImpl对应包")
    private static final String serviceImplPackage = "cn.sspku.test.serviceimpl";

    @ApiModelProperty(value = "controller对应包")
    private static final String controllerPackage = "cn.sspku.test.controller";
    ...
    public static String camel2Underline(String camelContext) {
        if (sspkuNullUtils.isNull(camelContext)) {
            return "";
        }
    ...
    public static String name(String classTitle, boolean isFirstUpper){
        if(sspkuNullUtils.isNull(classTitle)){
            throw new sspkuException("类名的长度必须是正数");
        }
