package cn.sspku.basics.security.validate;

import cn.sspku.basics.utils.ResponseUtil;
import cn.sspku.basics.parameter.CaptchaProperties;
...
public class ImageValidateFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(sspkuNullUtils.isNull(userInputCode) || sspkuNullUtils.isNull(verificationCodeId)){
        ...
        if(sspkuNullUtils.isNull(codeAnsInRedis)){
