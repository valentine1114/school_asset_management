package cn.sspku.test.controller;
...
public class StudentController {
    ...
    public Result<IPage<Student>> getByPage(@ModelAttribute Student student ,@ModelAttribute PageVo page){
        ...
        if(!sspkuNullUtils.isNull(student.getName())) {
            qw.like("name",student.getName());
        }
        if(!sspkuNullUtils.isNull(student.getNumber())) {
            qw.like("number",student.getNumber());
        }
        if(!sspkuNullUtils.isNull(student.getSex())) {
            qw.like("sex",student.getSex());
        }
        if(!sspkuNullUtils.isNull(student.getSchool())) {
