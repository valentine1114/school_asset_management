...
export const getAdminAssetsListAuditReturn = (params) => {
    return getRequest('/adminAssetsReturn/getByPageAuditReturn', params)
}
export const returnWage = (params) => {
    return postRequest('/adminAssetsReturn/returnWage', params)
}
// 添加
...
export const returnWarehouse = (params) => {
    return postRequest('/adminAssetsReturn/return', params)
}
export const returnApply = (params) => {
    return postRequest('/adminAssetsReturn/returnApply', params)
}
export const returnReturn = (params) => {
    return postRequest('/adminAssetsReturn/returnReturn', params)
}
...
export const submitReturnData = (params) => {
    return postRequest('/adminAssetsReturn/submitReturnData', params)
}
export const auditReturnData = (params) => {
    return postRequest('/adminAssetsReturn/auditReturnData', params)
}
