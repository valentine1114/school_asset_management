...
export default {
          ...
          render: (h, params) => {
            return h("div", [
              h(
                ...
                {
                  style: {
                    color: params.row.returnFlag == 2 ? "#ff0000" : "#000000",
                  },
                },
                params.row.returnFlag == 2 ? "[ 已退库 ]" : "[ 未退库 ]"
              ),
            ]);
          },
        },
        {
          ...
          render: (h, params) => {
            ...
            // 当 auditFlag 为 1 时，显示已被操作文本
              ...
              params.row.returnFlag === 2 ||
              params.row.returnFlag === 3
            ) {
              return h("div", [
                h(
                  "span",
  ...
  methods: {
    ...
    getDataList() {
      this.loading = true;
      getAdminAssetsListAuditReturn(this.searchForm).then((res) => {
        this.loading = false;
        if (res.success) {
