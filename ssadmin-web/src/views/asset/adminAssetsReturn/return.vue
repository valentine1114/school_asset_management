...
import {
  ...
  returnWarehouse,
  submitApplyData,
  getAdminAssetsApplyList,
  getAdminAssetsListReturn,
  submitReturnData,
} from "./api.js";
...
export default {
    ...
    return {
      ...
      columns: [
...

        {
          ...
          tooltip: true,
          render: (h, params) => {
            if (params.row.returnApprovalStatus == 0) {
              return h("div", [
                h(
                  "span",
                  {
            ...
            if (params.row.returnApprovalStatus == 1) {
              return h("div", [
                h(
                  "span",
                  {
            ...
            if (params.row.returnApprovalStatus == 2) {
              return h("div", [
                h(
                  "span",
                  {
            ...
            return h("div", [
              h(
                "span",
                {
                  style: {
                    color:
                      params.row.return_approval_status == 2
                        ? "#000000"
                        : "#ff0000",
                  },
                },
              ...
              h(
                "Button",
                {
                  props: {
                    ...
                    disabled:
                      (params.row.status !== 2 && params.row.status !== 1) ||
                      params.row.returnApprovalStatus == 1,
                  },
                  style: {
                    marginRight: "5px",
                  },
  ...
  methods: {
    ...
    getDataList() {
      this.loading = true;
      getAdminAssetsListReturn(this.searchForm).then((res) => {
        this.loading = false;
        if (res.success) {
