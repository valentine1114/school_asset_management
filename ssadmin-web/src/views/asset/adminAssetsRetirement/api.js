...
export const submitRetireData = (params) => {
    return postRequest('/adminAssetsRetire/submitRetireData', params)
}
...
export const getAdminAssetsRetirerOne = (params) => {
    return getRequest('/adminAssetsRetire/getOne', params)
}
export const getAdminAssets = (params) => {
    return getRequest('/adminAssetsRetire/getByPage', params)
}
export const getAdminAssetsRetireCount = (params) => {
    return getRequest('/adminAssetsRetire/count', params)
}
export const addAdminAssetsRetire = (params) => {
    return postRequest('/adminAssetsRetire/insert', params)
}
export const editAdminAssetsRetire = (params) => {
    return postRequest('/adminAssetsRetire/update', params)
}
export const addOrEditAdminAssetsRetire = (params) => {
    return postRequest('/adminAssetsRetire/insertOrUpdate', params)
}
export const deleteAdminAssetsRetire = (params) => {
    return postRequest('/adminAssetsRetire/delByIds', params)
}
export const retireApproval = (params) => {
    return postRequest('/adminAssetsRetire/retireApproval', params)
}
export const retireDisapproval = (params) => {
    return postRequest('/adminAssetsRetire/retireDisapproval', params)
}