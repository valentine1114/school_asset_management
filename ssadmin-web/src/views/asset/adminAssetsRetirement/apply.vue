...
export default {
    ...
    return {
      ...
      columns: [
...

        {
          ...
          tooltip: true,
          render: (h, params) => {
            if (params.row.retireApprovalStatus == 0) {
              return h("div", [
                h(
                  "span",
                  {
            ...
            if (params.row.retireApprovalStatus == 3) {
              return h("div", [
                h(
                  "span",
                  {
            ...
            if (params.row.retireApprovalStatus == 2) {
              return h("div", [
                h(
                  "span",
                  {
            ...
            return h("div", [
              h(
                "span",
                {
                  style: {
                    color:
                      params.row.retireApprovalStatus == 2
                        ? "#000000"
                        : "#ff0000",
                  },
                },
              ...
              h(
                "Button",
                {
                  props: {
                    ...
                    disabled:
                      params.row.retireApprovalStatus == 1 ||
  ...
  methods: {
    ...
    getDataList() {
      this.loading = true;
      getAdminAssetsListMylist(this.searchForm).then((res) => {
        this.loading = false;
        if (res.success) {
