          ...
          >
            ...
            <Form-item style="margin-left: 10px" class="br">
              ...
              <Button
                ...
                >重置</Button
              >
              <Button @click="delAll" type="error" icon="md-trash" size="small"
                >批量销毁</Button
              >
              <Button @click="manyEdit" type="info" icon="md-trash" size="small"
                >批量出库</Button
              >
              <Button
                @click="excelData"
...
<script>
import { getAdminAssetsList, deleteAdminAssets, outWage } from "./api.js";
