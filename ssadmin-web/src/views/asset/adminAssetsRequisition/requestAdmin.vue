              ...
              h(
                "Button",
                {
                  props: {
                    ...
                    ghost: true,
                    disabled:
                      params.row.auditFlag !== 2 || params.row.status !== 1,
                  },
                  style: {
                    marginRight: "5px",
                  },
    ...
    outWageFx(rowData) {
      ...
      this.$Modal.confirm({
        ...
        onOk: () => {
          ...
          const id = rowData.assetId; // 直接使用rowData中的id
          outWage({
            //ids: v.assetId,
            ids: id,
          }).then((res) => {
