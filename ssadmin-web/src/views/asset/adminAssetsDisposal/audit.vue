            ...
            return h("div", [
              h(
                "span",
                {
                  style: {
                    color:
                      params.row.auditDisposeFlag == 0 ? "#000000" : "#ff0000",
                  },
                },
                params.row.auditDisposeFlag == 0 ? "[ 未处置 ]" : "[ 已处置 ]"
              ),
            ]);
          },
        },
        {
          ...
          render: (h, params) => {
            ...
            // 当 auditFlag 为 1 时，显示已被操作文本
              ...
              params.row.disposeFlag === 2 ||
              params.row.disposeFlag === 3
            ) {
              return h("div", [
                h(
                  "span",
