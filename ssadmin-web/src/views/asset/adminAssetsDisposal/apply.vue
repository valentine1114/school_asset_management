...
export default {
    ...
    return {
      ...
      columns: [
...

        {
          ...
          tooltip: true,
          render: (h, params) => {
            if (params.row.disposeApprovalStatus == 0) {
              return h("div", [
                h(
                  "span",
                  {
            ...
            if (params.row.disposeApprovalStatus == 3) {
              return h("div", [
                h(
                  "span",
                  {
            ...
            if (params.row.disposeApprovalStatus == 2) {
              return h("div", [
                h(
                  "span",
                  {
            ...
            return h("div", [
              h(
                "span",
                {
                  style: {
                    color:
                      params.row.disposeApprovalStatus == 2
                        ? "#000000"
                        : "#ff0000",
                  },
                },
              ...
              h(
                "Button",
                {
                  props: {
                    ...
                    disabled:
                      params.row.disposeApprovalStatus == 1 ||
  ...
  methods: {
    ...
    submitFx() {
      ...
      this.$Modal.confirm({
        title: "确认申处置?",
        content: "您确认要申请所选的 " + this.selectCount + " 条处置单?",
        loading: true,
        onOk: () => {
          let ids = "";
