...
export default {
            ...
            return h("div", [
              h(
                "span",
                {
                  style: {
                    color:
                      params.row.repairApprovalStatus > 0
                        ? "#000000"
                        : "#ff0000",
                  },
                },
                ...
                "Button",
                {
                  props: {
                    ...
                    disabled:
                      ...
                      params.row.repairApprovalStatus === 1,
                    //||params.row.repairApprovalStatus === 2,
                  },
                  style: {
                    marginRight: "5px",
                  },
  ...
  methods: {
    ...
    getDataList() {
      this.loading = true;
      getAdminAssetsMyList(this.searchForm).then((res) => {
        this.loading = false;
        if (res.success) {
